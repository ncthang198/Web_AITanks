...
function GSActionPhase () {
	...
	var TEAM_1_NAME_X = 1030;
	var TEAM_1_NAME_Y = 310;
	
	var TEAM_2_INVENTORY_X = 947;
	var TEAM_2_INVENTORY_Y = 434;
	var TEAM_2_NAME_X = 1030;
	var TEAM_2_NAME_Y = 460;
	...
	this.Draw = function () {
		...
		//Draw players name
		g_graphicEngine.DrawTextRGB(g_context, TEAM_1_NAME, TEAM_1_NAME_X, TEAM_1_NAME_Y, 200, "BlackOpsOne", 30, false, false, "center", "center", 189, 189, 189, 0.9, false, false, 150, 150, 150);
		g_graphicEngine.DrawTextRGB(g_context, TEAM_2_NAME, TEAM_2_NAME_X, TEAM_2_NAME_Y, 200, "BlackOpsOne", 30, false, false, "center", "center", 189, 189, 189, 0.9, false, false, 150, 150, 150);
